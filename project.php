    ...
    <div class="nav_address border">
        <p class="add_one">Deliver to</p>
             ...
             <div class="icon">
               ...
               <div style="margin-left:48px;" class="language border">
                <div class="flag">
              ...
              <div class="sign_in border"><a style="text-decoration:none;color:white;font-size:16px;" href="signin.php"> 
              ...
              <div style="margin-left:50px;" class="cart border">
